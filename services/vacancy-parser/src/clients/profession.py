...
from schemas_old import Profession, ProfessionResponse


__all__ = ["profession_client"]


# FIXME: Копипаста с сервиса telegram-bot. Вероятно, имеет смысл вынести сервисы в common/shared/clients
