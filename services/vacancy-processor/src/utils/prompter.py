...
resume_prompt = """
Ты — помощник по извлечению технических навыков из текста или резюме кандидата.
Твоя задача — максимально полно найти все упоминания хард-скиллов в области IT.
...
Примеры допустимых навыков: Python, Django, Django REST Framework, FastAPI, Celery, PostgreSQL, Redis, Docker, React, Vue, Git, Linux, Kubernetes, Nginx, JavaScript, TypeScript, Go.
